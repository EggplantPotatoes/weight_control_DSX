...
// @return 读出成功的字节数
//*/
// uint32_t STMFLASH_Read(uint32_t addrStart, uint16_t *pData, uint32_t dataLen)
//{
...
//*/
// uint32_t STMFLASH_Write_NoCheck(uint32_t addrStart, const uint16_t *pData, uint32_t dataLen)
//{
...
// @return 实际写入的数据量，单位：字节
//*/
// uint32_t STMFLASH_Write(uint32_t addrStart, const uint16_t *pData, uint32_t dataLen)
//{
//    uint32_t i = 0;
